...
public class RegisterActivity extends BenihActivity implements PakTaniController.Presenter
{
    ...
    private void loadAnimation()
    {
        ...
        ButterKnife.findById(this, R.id.daftar).startAnimation(animation);
    }
